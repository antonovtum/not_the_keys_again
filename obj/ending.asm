...
;src/ending.c:41: if (LY_REG < 144) {
	...
	sub	a, #0x90
	ret	NC
	C$ending.c$42$2_0$127	= .
	.globl	C$ending.c$42$2_0$127
;src/ending.c:42: HIDE_WIN;
	ldh	a, (_LCDC_REG + 0)
	and	a, #0xdf
	ldh	(_LCDC_REG + 0), a
	C$ending.c$43$2_0$127	= .
	.globl	C$ending.c$43$2_0$127
;src/ending.c:43: WX_REG = 160; //THIS IS TO COVER A BUG ON THE DMG!!! REMOVE IT FOR THE GBC VERSION
	ld	a, #0xa0
	ldh	(_WX_REG + 0), a
	C$ending.c$45$1_0$126	= .
	.globl	C$ending.c$45$1_0$126
;src/ending.c:45: }
	C$ending.c$45$1_0$126	= .
	.globl	C$ending.c$45$1_0$126
	XG$LCD_isr$0$0	= .
	...
	C$ending.c$47$1_0$129	= .
	.globl	C$ending.c$47$1_0$129
;src/ending.c:47: void ending_init(void){
;	---------------------------------
; Function ending_init
; ---------------------------------
_ending_init::
	C$ending.c$48$1_0$129	= .
	.globl	C$ending.c$48$1_0$129
;src/ending.c:48: ending_flags = 0b10000000;
	ld	hl, #_ending_flags
	ld	(hl), #0x80
	C$ending.c$51$1_0$129	= .
	.globl	C$ending.c$51$1_0$129
;src/ending.c:51: remove_VBL(VBL_isr);
	ld	de, #_VBL_isr
	push	de
	call	_remove_VBL
	pop	hl
	C$ending.c$52$1_0$129	= .
	.globl	C$ending.c$52$1_0$129
...
;C:/gbdk/include/gb/gb.h:1546: shadow_OAM[nb].y = 0;
	...
	ld	(hl), #0x00
	C$ending.c$59$3_0$129	= .
	.globl	C$ending.c$59$3_0$129
;src/ending.c:59: hide_sprite(25);
	C$ending.c$60$3_0$129	= .
	.globl	C$ending.c$60$3_0$129
;src/ending.c:60: }
	C$ending.c$60$3_0$129	= .
	.globl	C$ending.c$60$3_0$129
	XG$ending_init$0$0	= .
	...
	C$ending.c$62$3_0$149	= .
	.globl	C$ending.c$62$3_0$149
...
_prepare_ending_frame:
	dec	sp
	C$ending.c$64$1_0$149	= .
	.globl	C$ending.c$64$1_0$149
;src/ending.c:64: if(IS_ANIMATION_STARTED) {return;}
	ld	a, (#_ending_flags)
	bit	2, a
	jp	NZ,00116$
	C$ending.c$66$1_0$149	= .
	.globl	C$ending.c$66$1_0$149
;src/ending.c:66: ending_flags |= 0x04; //mark is_ended as true
	ld	hl, #_ending_flags
	ld	a, (hl)
	or	a, #0x04
	ld	(hl), a
	C$ending.c$67$1_0$149	= .
	.globl	C$ending.c$67$1_0$149
;src/ending.c:67: win_height = 0xB000u;
	ld	hl, #_win_height
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0xb0
	C$ending.c$69$1_0$149	= .
	.globl	C$ending.c$69$1_0$149
;src/ending.c:69: force = 4u; //initial force is 4u
	ld	hl, #_force
	ld	(hl), #0x04
	C$ending.c$72$1_0$149	= .
	.globl	C$ending.c$72$1_0$149
;src/ending.c:72: set_win_tiles(0,0, 20U, 3U, hud_map);
	...
	call	_set_win_tiles
	add	sp, #6
	C$ending.c$73$1_0$149	= .
	.globl	C$ending.c$73$1_0$149
...
;	spillPairReg hl
	...
	add	sp, #5
	pop	bc
	C$ending.c$74$2_0$151	= .
	.globl	C$ending.c$74$2_0$151
...
00114$:
	...
	sub	a, #0x05
	jr	NC, 00103$
	C$ending.c$75$3_0$152	= .
	.globl	C$ending.c$75$3_0$152
...
;src/ending.c:74: for(i=0; score_text[i] != 0 && i < 5; i++){
	...
	jr	00114$
00103$:
	C$ending.c$77$1_0$149	= .
	.globl	C$ending.c$77$1_0$149
;src/ending.c:77: set_win_tiles(8, 1, i, 1, score_text);
	...
	call	_set_win_tiles
	add	sp, #6
	C$ending.c$78$1_0$149	= .
	.globl	C$ending.c$78$1_0$149
...
;C:/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	...
	ld	(hl), #0x24
	C$ending.c$91$1_0$149	= .
	.globl	C$ending.c$91$1_0$149
;src/ending.c:91: subpix_speed = 252u;
	ld	hl, #_subpix_speed
	ld	(hl), #0xfc
	C$ending.c$99$1_0$149	= .
	.globl	C$ending.c$99$1_0$149
;src/ending.c:99: }
	di
	C$ending.c$94$2_0$153	= .
	.globl	C$ending.c$94$2_0$153
;src/ending.c:94: add_VBL(VBL_isr);
	ld	de, #_VBL_isr
	push	de
	call	_add_VBL
	pop	hl
	C$ending.c$95$2_0$153	= .
	.globl	C$ending.c$95$2_0$153
;src/ending.c:95: add_LCD(LCD_isr);
	ld	de, #_LCD_isr
	push	de
	call	_add_LCD
	pop	hl
	C$ending.c$96$2_0$153	= .
	.globl	C$ending.c$96$2_0$153
;src/ending.c:96: set_interrupts(VBL_IFLAG | LCD_IFLAG);
	...
	inc	sp
	C$ending.c$97$2_0$153	= .
	.globl	C$ending.c$97$2_0$153
;src/ending.c:97: STAT_REG |= 0x40; // enable LY == LYC mode 
	ldh	a, (_STAT_REG + 0)
	or	a, #0x40
	ldh	(_STAT_REG + 0), a
	C$ending.c$98$2_0$153	= .
	.globl	C$ending.c$98$2_0$153
;src/ending.c:98: LYC_REG = 160u;   // make it never fire
	ld	a, #0xa0
	ldh	(_LYC_REG + 0), a
	ei
00116$:
	C$ending.c$100$2_0$149	= .
	.globl	C$ending.c$100$2_0$149
;src/ending.c:100: }
	inc	sp
	C$ending.c$100$2_0$149	= .
	.globl	C$ending.c$100$2_0$149
	...
	C$ending.c$102$2_0$179	= .
	.globl	C$ending.c$102$2_0$179
;src/ending.c:102: void compute_ending_frame(void){
;	---------------------------------
; Function compute_ending_frame
; ---------------------------------
_compute_ending_frame::
	C$ending.c$103$1_0$179	= .
	.globl	C$ending.c$103$1_0$179
...
;C:/gbdk/include/gb/gb.h:1521: itm->y=y, itm->x=x;
	...
	inc	hl
	ld	(hl), #0xa0
	C$ending.c$113$1_0$179	= .
	.globl	C$ending.c$113$1_0$179
;src/ending.c:113: if(subpix_speed > MAX_SPEED) {
	ld	a, #0x0d
	ld	hl, #_subpix_speed
	sub	a, (hl)
	jr	NC, 00104$
	C$ending.c$114$2_0$180	= .
	.globl	C$ending.c$114$2_0$180
...
;C:/gbdk/include/gb/gb.h:1493: shadow_OAM[nb].prop=prop;
	...
	ld	(hl), #0x20
	C$ending.c$116$1_0$179	= .
	.globl	C$ending.c$116$1_0$179
;src/ending.c:116: set_sprite_prop(25, S_FLIPX);
	jr	00105$
00104$:
	C$ending.c$118$1_0$179	= .
	.globl	C$ending.c$118$1_0$179
;src/ending.c:118: else if(subpix_speed == 0) {
	ld	a, (#_subpix_speed)
	or	a, a
	jr	NZ, 00105$
	C$ending.c$120$2_0$181	= .
	.globl	C$ending.c$120$2_0$181
;src/ending.c:120: ending_flags |= 0b00001001; //IS_FORCE_ADDED = true, IS_ANIMATION_FINISHED = true
	ld	hl, #_ending_flags
	ld	a, (hl)
	or	a, #0x09
	ld	(hl), a
	C$ending.c$121$2_0$181	= .
	.globl	C$ending.c$121$2_0$181
;src/ending.c:121: ending_flags ^= 0b00000010; //swap WIN_DIRECTION
	ld	a, (hl)
	xor	a, #0x02
	ld	(hl), a
	C$ending.c$122$2_0$181	= .
	.globl	C$ending.c$122$2_0$181
...
;C:/gbdk/include/gb/gb.h:1493: shadow_OAM[nb].prop=prop;
	...
	ld	hl, #(_shadow_OAM + 103)
	ld	(hl), #0x00
	C$ending.c$124$1_0$179	= .
	.globl	C$ending.c$124$1_0$179
;src/ending.c:124: set_sprite_prop(25, 0x00);
00105$:
	C$ending.c$114$1_0$179	= .
	.globl	C$ending.c$114$1_0$179
;src/ending.c:114: ending_flags &= 0b11110111; //IS_FORCE_ADDED = false
	ld	hl, #_ending_flags
	ld	e, (hl)
	C$ending.c$127$1_0$179	= .
	.globl	C$ending.c$127$1_0$179
;src/ending.c:127: if(IS_ANIMATION_FINISHED){      
	bit	0, e
	jr	Z, 00107$
	C$ending.c$128$2_0$182	= .
	.globl	C$ending.c$128$2_0$182
;src/ending.c:128: force ^= 0x01; //make the force smaller for the sway, either 1 or 0
	...
	ld	(hl), a
00107$:
	C$ending.c$130$1_0$179	= .
	.globl	C$ending.c$130$1_0$179
...
00122$:
	ld	hl, #_subpix_speed
	ld	(hl), a
	C$ending.c$131$1_0$179	= .
	.globl	C$ending.c$131$1_0$179
...
00124$:
	...
	ld	(hl+), a
	ld	(hl), b
	C$ending.c$132$1_0$179	= .
	.globl	C$ending.c$132$1_0$179
;src/ending.c:132: max_scan = WIN_PIXEL + 24U; //REMOVE THE 1PX PADDING FOR THE CGB VERSION (23U)
	ld	a, (hl)
	add	a, #0x18
	ld	(#_max_scan),a
	C$ending.c$133$1_0$179	= .
	.globl	C$ending.c$133$1_0$179
;src/ending.c:133: }
	C$ending.c$133$1_0$179	= .
	.globl	C$ending.c$133$1_0$179
