M:sound
S:Lsound.set_2bpp_palette$palette$1_0$35({2}SI:U),B,1,2
S:Lsound.set_1bpp_colors$fgcolor$1_0$38({1}SC:U),B,1,2
S:Lsound.set_1bpp_colors$bgcolor$1_0$38({1}SC:U),B,1,3
S:Lsound.set_bkg_based_tiles$x$1_0$44({1}SC:U),B,1,2
S:Lsound.set_bkg_based_tiles$y$1_0$44({1}SC:U),B,1,3
S:Lsound.set_bkg_based_tiles$w$1_0$44({1}SC:U),B,1,4
S:Lsound.set_bkg_based_tiles$h$1_0$44({1}SC:U),B,1,5
S:Lsound.set_bkg_based_tiles$tiles$1_0$44({2}DG,SC:U),B,1,6
S:Lsound.set_bkg_based_tiles$base_tile$1_0$44({1}SC:U),B,1,8
S:Lsound.set_bkg_based_submap$x$1_0$47({1}SC:U),B,1,2
S:Lsound.set_bkg_based_submap$y$1_0$47({1}SC:U),B,1,3
S:Lsound.set_bkg_based_submap$w$1_0$47({1}SC:U),B,1,4
S:Lsound.set_bkg_based_submap$h$1_0$47({1}SC:U),B,1,5
S:Lsound.set_bkg_based_submap$map$1_0$47({2}DG,SC:U),B,1,6
S:Lsound.set_bkg_based_submap$map_w$1_0$47({1}SC:U),B,1,8
S:Lsound.set_bkg_based_submap$base_tile$1_0$47({1}SC:U),B,1,9
S:Lsound.move_bkg$x$1_0$52({1}SC:U),B,1,2
S:Lsound.move_bkg$y$1_0$52({1}SC:U),B,1,3
S:Lsound.scroll_bkg$x$1_0$54({1}SC:S),B,1,2
S:Lsound.scroll_bkg$y$1_0$54({1}SC:S),B,1,3
S:Lsound.set_win_based_tiles$x$1_0$61({1}SC:U),B,1,2
S:Lsound.set_win_based_tiles$y$1_0$61({1}SC:U),B,1,3
S:Lsound.set_win_based_tiles$w$1_0$61({1}SC:U),B,1,4
S:Lsound.set_win_based_tiles$h$1_0$61({1}SC:U),B,1,5
S:Lsound.set_win_based_tiles$tiles$1_0$61({2}DG,SC:U),B,1,6
S:Lsound.set_win_based_tiles$base_tile$1_0$61({1}SC:U),B,1,8
S:Lsound.set_win_based_submap$x$1_0$64({1}SC:U),B,1,2
S:Lsound.set_win_based_submap$y$1_0$64({1}SC:U),B,1,3
S:Lsound.set_win_based_submap$w$1_0$64({1}SC:U),B,1,4
S:Lsound.set_win_based_submap$h$1_0$64({1}SC:U),B,1,5
S:Lsound.set_win_based_submap$map$1_0$64({2}DG,SC:U),B,1,6
S:Lsound.set_win_based_submap$map_w$1_0$64({1}SC:U),B,1,8
S:Lsound.set_win_based_submap$base_tile$1_0$64({1}SC:U),B,1,9
S:Lsound.move_win$x$1_0$69({1}SC:U),B,1,2
S:Lsound.move_win$y$1_0$69({1}SC:U),B,1,3
S:Lsound.scroll_win$x$1_0$71({1}SC:S),B,1,2
S:Lsound.scroll_win$y$1_0$71({1}SC:S),B,1,3
S:Lsound.SET_SHADOW_OAM_ADDRESS$address$1_0$76({2}DG,SV:S),B,1,2
S:Lsound.set_sprite_tile$nb$1_0$78({1}SC:U),B,1,2
S:Lsound.set_sprite_tile$tile$1_0$78({1}SC:U),B,1,3
S:Lsound.get_sprite_tile$nb$1_0$80({1}SC:U),B,1,2
S:Lsound.set_sprite_prop$nb$1_0$82({1}SC:U),B,1,2
S:Lsound.set_sprite_prop$prop$1_0$82({1}SC:U),B,1,3
S:Lsound.get_sprite_prop$nb$1_0$84({1}SC:U),B,1,2
S:Lsound.move_sprite$nb$1_0$86({1}SC:U),B,1,2
S:Lsound.move_sprite$x$1_0$86({1}SC:U),B,1,3
S:Lsound.move_sprite$y$1_0$86({1}SC:U),B,1,4
S:Lsound.move_sprite$itm$1_0$87({2}DG,STOAM_item_t:S),B,1,-2
S:Lsound.scroll_sprite$nb$1_0$88({1}SC:U),B,1,2
S:Lsound.scroll_sprite$x$1_0$88({1}SC:S),B,1,3
S:Lsound.scroll_sprite$y$1_0$88({1}SC:S),B,1,4
S:Lsound.scroll_sprite$itm$1_0$89({2}DG,STOAM_item_t:S),B,1,-2
S:Lsound.hide_sprite$nb$1_0$90({1}SC:U),B,1,2
S:Lsound.set_native_tile_data$first_tile$1_0$98({2}SI:U),B,1,2
S:Lsound.set_native_tile_data$nb_tiles$1_0$98({1}SC:U),B,1,4
S:Lsound.set_native_tile_data$data$1_0$98({2}DG,SC:U),B,1,5
F:G$sound_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$stop_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$play_jump_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$stop_jump_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$play_bump_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$play_break_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$play_hurt_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$stop_hurt_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$play_boing_sfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
