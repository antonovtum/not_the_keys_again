...
S:Lmain.move_metasprite$metasprite$1_0$104({2}DG,STmetasprite_t:S),B,1,2
S:Lmain.move_metasprite$base_tile$1_0$104({1}SC:U),B,1,4
S:Lmain.move_metasprite$base_sprite$1_0$104({1}SC:U),B,1,5
S:Lmain.move_metasprite$x$1_0$104({1}SC:U),B,1,6
S:Lmain.move_metasprite$y$1_0$104({1}SC:U),B,1,7
S:Lmain.move_metasprite_vflip$metasprite$1_0$106({2}DG,STmetasprite_t:S),B,1,2
S:Lmain.move_metasprite_vflip$base_tile$1_0$106({1}SC:U),B,1,4
S:Lmain.move_metasprite_vflip$base_sprite$1_0$106({1}SC:U),B,1,5
S:Lmain.move_metasprite_vflip$x$1_0$106({1}SC:U),B,1,6
S:Lmain.move_metasprite_vflip$y$1_0$106({1}SC:U),B,1,7
S:Lmain.move_metasprite_hflip$metasprite$1_0$108({2}DG,STmetasprite_t:S),B,1,2
S:Lmain.move_metasprite_hflip$base_tile$1_0$108({1}SC:U),B,1,4
S:Lmain.move_metasprite_hflip$base_sprite$1_0$108({1}SC:U),B,1,5
S:Lmain.move_metasprite_hflip$x$1_0$108({1}SC:U),B,1,6
S:Lmain.move_metasprite_hflip$y$1_0$108({1}SC:U),B,1,7
S:Lmain.move_metasprite_hvflip$metasprite$1_0$110({2}DG,STmetasprite_t:S),B,1,2
S:Lmain.move_metasprite_hvflip$base_tile$1_0$110({1}SC:U),B,1,4
S:Lmain.move_metasprite_hvflip$base_sprite$1_0$110({1}SC:U),B,1,5
S:Lmain.move_metasprite_hvflip$x$1_0$110({1}SC:U),B,1,6
S:Lmain.move_metasprite_hvflip$y$1_0$110({1}SC:U),B,1,7
S:Lmain.hide_metasprite$metasprite$1_0$112({2}DG,STmetasprite_t:S),B,1,2
S:Lmain.hide_metasprite$base_sprite$1_0$112({1}SC:U),B,1,4
S:Lmain.aligned_alloc$alignment$1_0$126({2}SI:U),B,1,2
S:Lmain.aligned_alloc$size$1_0$126({2}SI:U),B,1,4
F:G$performant_delay$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.performant_delay$frames$1_0$156({1}SC:U),B,1,2
S:Lmain.performant_delay$ii$1_0$157({1}SC:U),R,0,0,[c]
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$reset_game$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$init_gfx$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
T:Fmain$Window_status[({0}S:S$components$0_0$0({1}SC:U),Z,0,0)({1}S:S$status$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$Rectangle[({0}S:S$x$0_0$0({1}SC:U),Z,0,0)({1}S:S$y$0_0$0({1}SC:U),Z,0,0)({2}S:S$size_x$0_0$0({1}SC:U),Z,0,0)({3}S:S$size_y$0_0$0({1}SC:U),Z,0,0)({4}S:S$type$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$Window_component_struct[({0}S:S$y_offset$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)({2}S:S$map$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$collider$0_0$0({5}STRectangle:S),Z,0,0)]
...
S:Fmain$score_text$0_0$0({5}DA5d,SC:S),E,0,0
...
S:G$ending_init$0_0$0({2}DF,SV:S),C,0,0
S:G$compute_ending_frame$0_0$0({2}DF,SV:S),C,0,0
S:G$show_window$0_0$0({2}DF,SV:S),C,0,0
