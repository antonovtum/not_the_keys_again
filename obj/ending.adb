...
F:Fending$scanline_interrupt_script$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lending.scanline_interrupt_script$max_scan$1_0$126({1}SC:U),R,0,0,[c]
F:G$ending_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fending$prepare_ending_frame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lending.prepare_ending_frame$__1310720006$2_0$136({1}SC:U),R,0,0,[]
S:Lending.prepare_ending_frame$__1310720007$2_0$136({1}SC:U),R,0,0,[]
S:Lending.prepare_ending_frame$x$3_0$137({1}SC:U),R,0,0,[]
S:Lending.prepare_ending_frame$y$3_0$137({1}SC:U),R,0,0,[]
S:Lending.prepare_ending_frame$sloc0$0_1$0({1}SC:S),B,1,-1
F:G$compute_ending_frame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lending.compute_ending_frame$__1310720009$2_0$141({1}SC:U),R,0,0,[]
S:Lending.compute_ending_frame$__1310720010$2_0$141({1}SC:U),R,0,0,[c]
S:Lending.compute_ending_frame$x$3_0$142({1}SC:U),R,0,0,[]
S:Lending.compute_ending_frame$y$3_0$142({1}SC:U),R,0,0,[]
...
S:Fending$counter$0_0$0({1}SC:U),E,0,0
S:Fending$is_ended$0_0$0({1}:S),E,0,0
S:Fending$win_height$0_0$0({1}SC:U),E,0,0
...
S:Fending$scanline_interrupt_script$0_0$0({2}DF,SV:S),C,0,0
